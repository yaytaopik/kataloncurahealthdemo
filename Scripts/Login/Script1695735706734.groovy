...
WebUI.setEncryptedText(findTestObject('Object Repository/Login/Page_CURA Healthcare Service/input_Password_password'), 'ThisIsNotAPassword')

WebUI.click(findTestObject('Object Repository/Login/Page_CURA Healthcare Service/button_Login'))

if (WebUI.waitForElementVisible(findTestObject('Object Repository/Login/Page_CURA Healthcare Service/h1_CURA Healthcare Service'), 5) == true) {
	String message = "Login Berhasil !"
	KeywordUtil.markPassed(message)
} else {
	String messageFailedLogin = "Gagal Login"
	KeywordUtil.markFailed(messageFailedLogin)
}
